...
login_mager = LoginManager()
login_mager.init_app(app)


@login_mager.user_loader
...
app.config['SQLALCHEMY_DATABASE_URI'] = os.environ.get("DATABASE_URL", 'sqlite:///posts.db') + "?sslmode=require"
